...
class CVEClassifier:
    ...
    def __init__(self, embedding_size=300, max_features=None,
        ...
        self.MAX_FEATURES = 557002 if not max_features else max_features
        self.MAX_LEN = 1000 if not max_length else max_length
        self.TOKENIZER_PATH = '../../../../tokenizer_vocab/cve_tokenizer_word2idx.pkl' \
        ...
        self.GRU_UNITS = 32
        self.MODEL_WEIGHTS_PATH = '../../../../models/model2_cve_noncve_demo_weights.h5'
        self.MODEL = None
