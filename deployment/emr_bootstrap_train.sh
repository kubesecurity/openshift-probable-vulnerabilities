...
curl https://raw.githubusercontent.com/rootavish/openshift-probable-vulnerabilities/emr-build/model_inference_triage_pipeline/requirements.txt -o requirements.txt
